...
function makeForwardMsg (e, msg = [], dec) {
  ...
  if (e?.group?.makeForwardMsg) { return e.group.makeForwardMsg(forwardMsg) } else if (e?.friend?.makeForwardMsg) { return e.friend.makeForwardMsg(forwardMsg) } else { return Bot.makeForwardMsg(forwardMsg) }
}
