...
export const SymbolContextHandler = Symbol("ContextHandler")
export const SymbolContextPlugin = Symbol("ContextPlugin")
...
export default class plugin {
  ...
  setContext (type, isGroup, time = 120, timeout = "操作超时已取消") {
    ...
    if (typeof this[type] === "function") {
      stateArr[key][type][SymbolContextHandler] = this[type]
      stateArr[key][type][SymbolContextPlugin] = this
    }
    if (time) {
